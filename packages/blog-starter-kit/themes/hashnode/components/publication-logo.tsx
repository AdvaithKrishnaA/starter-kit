...
const CustomLogo = ({ publication, size = 'lg', isPostPage }: {
  publication: Pick<PublicationFragment, 'title'> & {
    author: Pick<User, 'name'>;
  } & {
    preferences: Pick<Preferences, 'darkMode'>;
